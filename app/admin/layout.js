...
import {
  ...
  BarChart3, TrendingUp, Map, LogOut, Menu, X, ShieldAlert,
  FileBadge, ClipboardCheck, GraduationCap, Wrench, Bell, Settings, ChevronRight,
} from 'lucide-react';
...
const menuItems = [
  ...
  { label: 'Permits',            href: '/admin/permits',            icon: FileBadge       },
  { label: 'Inspections',        href: '/admin/inspections',        icon: ClipboardCheck  },
  { label: 'Training',           href: '/admin/training',           icon: GraduationCap   },
  { label: 'Corrective Actions', href: '/admin/corrective-actions', icon: Wrench          },
    ...
    <div className="flex h-screen bg-gray-100 overflow-hidden">
      ...
      `}>
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-white/10 flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              ...
              <p className="text-[10px] text-slate-400 tracking-wider uppercase">HSE Management</p>
            </div>
          </div>
          <button
            onClick={() => setSidebarOpen(false)}
        ...
        <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto scrollbar-thin scrollbar-thumb-white/10">
          <p className="px-3 pb-2 text-[9px] font-bold uppercase tracking-[0.12em] text-slate-500 select-none">
            Navigation
          </p>
          {menuItems.map((item) => {
        ...
        <div className="px-5 py-2 flex-shrink-0">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[9px] text-slate-600 font-mono tracking-widest">v2.1.0</span>
            <div className="flex-1 h-px bg-white/8" />
          </div>
        </div>
        ...
        <div className="px-3 pb-4 flex-shrink-0 space-y-2">
          <div className="flex items-center gap-2.5 px-3 py-2.5 rounded-xl bg-white/6 border border-white/8">
            <div className="w-8 h-8 rounded-full bg-slate-600 flex items-center justify-center text-white text-xs font-bold flex-shrink-0 ring-2 ring-white/20">
              {initials}
            </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <header className="bg-white border-b border-gray-200 px-4 sm:px-6 py-0 flex items-center justify-between shadow-sm flex-shrink-0 h-14">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Settings shortcut */}
            <button className="hidden sm:flex w-8 h-8 items-center justify-center rounded-xl hover:bg-gray-100 transition text-gray-500 hover:text-gray-700">
              <Settings size={16} />
            </button>
            ...
            {/* User pill */}
            <div className="flex items-center gap-2 px-2.5 py-1.5 bg-gray-50 border border-gray-200 rounded-xl cursor-default hover:bg-gray-100 transition">
